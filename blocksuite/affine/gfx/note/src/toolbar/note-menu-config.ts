...
const LIST_ITEMS = [
  {
    ...
    type: 'bulleted',
    name: '无序列表',
    description: '一个简单的无序列表。',
    icon: BulletedListIcon,
    tooltip: '拖拽/点击以插入无序列表',
  },
  {
    flavour: 'affine:list',
    type: 'numbered',
